<template>
    <div class="container-fluid">
        <div class="navbar mw-100 px-3">
            ...
            <div class="nav-right">
                <router-link to="/menber" class="d-none d-md-inline-block">
                ...
                <router-link to="/cart">
                    <svg xmlns="http://www.w3.org/2000/svg" width="30px" fill="currentColor" class="bi bi-bag mw-100" viewBox="0 0 16 16">
